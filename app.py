...
for i in kurum:
    ...
    for orbi in organizasyonBirimleri:
        obf = OrganizasyonBirimiFormu(newKurum.bakanlik, newKurum.adi, newKurum.k_adi,orbi_counter, orbidict['cbs_birimi_var'],orbidict['cbs_yeni_birim_gerekli'],
                                    orbidict['veri_uretim_var'],orbidict['tasra_teskilati_var'],orbidict['sadece_sistem_idamesi_var'],orbidict['ihtiyaclar_sizin_onayinizdan_geciyor'],
                                    orbidict['personel_yeterli'],orbidict['personel_yetersizlik_kriterleri'],orbidict['personel_yetersizlik_oneri'],orbidict['cbs_farkindaligi_vari'],
                                    orbidict['sorunlar'],orbidict['cbs_birim_adi'],orbidict['yapilanma_olcegi'],orbidict['kurum_semasindaki_yeri'],orbidict['tasra_teskilat_yapilanmasi'],
                                    orbidict['cbs_yeni_birim_gorusler'])
        orbi_counter += 1
        obf.createExcelFile()
